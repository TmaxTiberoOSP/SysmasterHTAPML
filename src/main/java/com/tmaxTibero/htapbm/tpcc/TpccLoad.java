...
//    static int DB_STRING_MAX = 51;
    ...
    private int runLoad(boolean overridePropertiesFile, String[] argv) {
        ...
        Load.jdbcProperties = properties;
...
/*            try {
            ...
            loadConfig.setLoadType(TpccLoadConfig.LoadType.JDBC_PREPARED_STATEMENT);
        ...
        System.out.printf("TPCC Create Table...\n");
        try {
            Load.dropTables(loadConfig, option_debug);
            Load.createTables(loadConfig, option_debug);
        } catch (Exception e) {
