    ...
    public int neword(int t_num,           /* thread number (not used) */
        ...
        try {
            ...
            if (joins) {
                ...
                try (PreparedStatement pstmt0 = pStmts.prepareStatement(pStmts.getSqlString(0))) {
                    int column = 1;
                    pstmt0.setInt(column++, w_id);
                    pstmt0.setInt(column++, w_id); // This seems redundant, double-check the logic
                ...
                try {
                    ...
                    try (PreparedStatement pstmt35 = pStmts.prepareStatement(pStmts.getSqlString(35))) {
                    ...
                    try (PreparedStatement pstmt36 = pStmts.prepareStatement(pStmts.getSqlString(36))) {
            ...
            try (PreparedStatement pstmt1 = pStmts.prepareStatement(pStmts.getSqlString(1))) {
            ...
            try (PreparedStatement pstmt2 = pStmts.prepareStatement(pStmts.getSqlString(2))) {
            ...
            try (PreparedStatement pstmt3 = pStmts.prepareStatement(pStmts.getSqlString(3))) {
                pstmt3.setInt(1, o_id);
                pstmt3.setInt(2, d_id);
                pstmt3.setInt(3, w_id);
                pstmt3.setInt(4, c_id);
                pstmt3.setTimestamp(5, currentTimeStamp);
            ...
            try (PreparedStatement pstmt4 = pStmts.prepareStatement(pStmts.getSqlString(4))) {
            ...
            for (ol_number = 1; ol_number <= o_ol_cnt; ol_number++) {
                ...
                try (PreparedStatement pstmt5 = pStmts.prepareStatement(pStmts.getSqlString(5))) {
                ...
                try (PreparedStatement pstmt6 = pStmts.prepareStatement(pStmts.getSqlString(6))) {
                ...
                try (PreparedStatement pstmt7 = pStmts.prepareStatement(pStmts.getSqlString(7))) {
                ...
                try (PreparedStatement pstmt8 = pStmts.prepareStatement(pStmts.getSqlString(8))) {
