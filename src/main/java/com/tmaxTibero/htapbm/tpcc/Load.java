...
public class Load implements TpccConstants {
    ...
    private static final String CREATE_TABLE = "database/create_tables.sql";
    private static final String DROP_TABLE = "database/drop_tables.sql";
    ...
    public static void createTables(TpccLoadConfig loadConfig, boolean optionDebug) throws Exception {
        String sqlScript = new String(Files.readAllBytes(Paths.get(CREATE_TABLE)));
        try (Connection conn = DriverManager.getConnection(jdbcProperties.getProperty("JDBCURL"),
                jdbcProperties.getProperty("USER"), jdbcProperties.getProperty("PASSWORD"));
             Statement stmt = conn.createStatement()) {

            // Assuming your SQL script contains multiple statements separated by semicolons
    ...
    public static void dropTables(TpccLoadConfig loadConfig, boolean optionDebug) throws Exception {
        String sqlScript = new String(Files.readAllBytes(Paths.get(DROP_TABLE)));
        try (Connection conn = DriverManager.getConnection(jdbcProperties.getProperty("JDBCURL"),
                jdbcProperties.getProperty("USER"), jdbcProperties.getProperty("PASSWORD"));
             Statement stmt = conn.createStatement()) {
