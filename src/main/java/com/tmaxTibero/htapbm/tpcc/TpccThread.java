...
public class TpccThread extends Thread {
    ...
    public static boolean[] terminateCheck;
    ...
    public TpccThread(int number, int port, int is_local, String db_user, String db_password,
        ...
        driver = new Driver(conn, fetchSize,
                ...
                success2, late2, retry2, failure2, joins, jdbcUrl, db_user, db_password);
    }
    ...
    private Connection connectToDatabase() {
        ...
        logger.info("Session attached (Session number: " + number + ")");
        ...
        try {
            ...
            // logger.info("[INIT] conn-id: " + conn + " thread-id: " + Thread.currentThread().getId());
